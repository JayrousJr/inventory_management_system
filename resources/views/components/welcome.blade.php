<div
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900 dark:text-white">
        Welcome to {{env('APP_NAME')}} System!
    </h1>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">
                <a href="https://laravel.com/docs">{{env('APP_NAME')}}</a>
            </h2>
        </div>

        <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            Welcome to the {{env('APP_NAME')}}, You can set your account credentials and details in the left upper
            corner. In the bottom link to visit Shop Panel.
        </p>
